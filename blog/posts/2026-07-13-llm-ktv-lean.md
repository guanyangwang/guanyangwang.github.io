...
- Levent Alpöge announced an explicit three-variable counterexample to the general Jacobian conjecture, crediting Claude Fable 5 with the construction: the [announcement](https://x.com/__alpoge__/status/2079028340955197566) and an [independent Isabelle/HOL verification](https://isa-afp.org/entries/Jacobian_Counterexample.html).
- ChatGPT 5.6 Pro found the initial proof of our sharp small-deviation inequality, which resolves Feige’s \(1/e\) conjecture: the [paper](https://arxiv.org/abs/2607.23980), [Lean formalization](https://github.com/pengzhang91/Feige), and [blog post](./feige-conjecture.html). Two other preprints appeared independently on the same day: [Nie and Wei](https://arxiv.org/abs/2607.24528) and [Stander](https://doi.org/10.5281/zenodo.21626794).
- Dmitry Rybin used GPT-5.6 Pro to produce an explicit counterexample to the cost version of the Dinitz–Garg–Goemans conjecture: the [announcement](https://x.com/DmitryRybin1/status/2079904005652893709) and [prompt transcript](https://chatgpt.com/share/6a60b2eb-0b64-83ee-9c76-7931ca1de063).
...
There is also an important caveat: current LLMs still miss many relevant references, even when they find the core proof idea. Human authors need to read the generated proof carefully, trace every ingredient back to the literature, and add the citations the model omitted. This is part of verification, not merely editorial cleanup.
...
Another famous example of *废话文学* (“tautological literature”) says, *问题的关键就是抓住关键的问题*—“The key to the problem is to grasp the key problem.” It sounds like a joke, but with current LLMs it is becoming surprisingly accurate. Once models make many execution-level costs extremely low, identifying the truly key problem becomes a much larger part of the work.
